...
import Miri from '../../src/svgFile/miri.svg';
import Letter from '../../src/svgFile/letter.svg';
import Letter2 from '../../src/svgFile/letter2.svg';
import Text2 from '../../src/svgFile/textletter.svg';
...
export default function Tutorial4({navigation}){
  ...
  return(
          ...
          <View style={{flex:1, flexDirection:"row", justifyContent:"center", alignContent: "center"}}>
            ...
            <Miri style={{position:"absolute",top:117.82}} ></Miri>
            <Letter style={{position:"absolute",top:180.71}}></Letter>
            <Letter2 style={{position:"absolute",top:234.31}}></Letter2>
            <Text2 style={{position:"absolute",top:661.38}}></Text2>
