...
import Phone from '../../src/svgFile/phone.svg';
...
export default function Tutorial2({navigation}){
  ...
  return(
          ...
          <View style={{flex:1, flexDirection:"row", justifyContent:"center", alignContent: "center"}}>
            ...
            <Phone style={{position:"absolute",top:114.38}}></Phone>
               
                    <Text style={{position:"absolute",top:661.38,color:"#03CF5D",fontSize:20,fontWeight:"bold"}}>음성인식 기능으로</Text>
                    <Text style={{position:"absolute",top:690.38,color:"black",fontSize:20,fontWeight:"bold",}}>쉬운검색이 가능해요!</Text>
